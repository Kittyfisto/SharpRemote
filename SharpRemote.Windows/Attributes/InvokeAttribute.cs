...
namespace SharpRemote
{
	...
	///     - <see cref="Dispatch.SerializePerMethod"/>: Concurrent invocations of this method (or property/event) are serialized and executed one after the other
	///     - <see cref="Dispatch.SerializePerObject"/>: Concurrent invocations of this method AND any other on the SAME object with the same invokation-type are serialized and executed one after the other
	///     - <see cref="Dispatch.SerializePerType"/>: Concurrent invocations of this method AND any other method on the SAME interface with the same invokation-type are serialized and executed one after the other
	/// </summary>
